import initLib3MF from '../build/lib3mfEmscriptenTest.js';
import fs from 'fs';
...
function createGyroidFunction(model, lib3mf) {
    ...
    gyroidFunction.AddLink(decomposePos.GetOutputZ(), composeYZX.GetInputY());
    gyroidFunction.AddLink(decomposePos.GetOutputY(), composeYZX.GetInputX());
    ...
    gyroidFunction.AddLink(composeYZX.GetOutputResult(), cosNode.GetInputA());
    ...
    // Link the nodes
    gyroidFunction.AddLink(absNode.GetOutputResult(), subtractionNode.GetInputA());
    gyroidFunction.AddLink(halfThicknessNode.GetOutputValue(), subtractionNode.GetInputB());
    ...
    gyroidFunction.AddLink(subtractionNode.GetOutputResult(), output);
